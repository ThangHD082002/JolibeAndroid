...
public class RecycleViewHomTwoAdapter extends RecyclerView.Adapter<RecycleViewHomTwoAdapter.ViewHolder>{

    private Context context;
    List<Food> list;


    public RecycleViewHomTwoAdapter(Context context, List<Food> list) {
